...
axis(2, at = c(1:2), labels = c("men", "women"), las = 2, cex.axis = 2)
...
```{r echo = FALSE, dpi = 300, warning = FALSE, fig.width=10, fig.height=5, out.width='65%', out.height='65%', fig.align="center"}
par(mfrow = c(1,2))
plot(x,y, main = "lowess")
lines(lowess(x, y))
scatter.smooth(x,y, main = "loess")
...
```{r vizfunctions, echo = TRUE, dpi = 300, fig.width=5, fig.height=5, out.width='20%', out.height='20%', fig.align="center"}
...
```{r snippets, echo = TRUE, eval = FALSE}
